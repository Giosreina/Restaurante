...
public class CreadorCombo {
    ...
    public Alimento crearComida(String nombre, double precio, String tipoComida, String descripcion){
        Alimento comparador = recetas.get(nombre);
        if(comparador == null){
            comparador = new Alimento(nombre, precio, tipoComida,descripcion);
